...
Соответствие вида метаданных и префикса ссылочного типа приведено в разделе
[«Границы резолюции ссылочных типов»](#границы-резолюции-ссылочных-типов) — таблица там синхронизирована
с `REFERENCE_TYPE_PREFIXES` guard-тестом (#168).
...
Исследование #143 сформулировало гипотезу платформенной природы остатка; она
остаётся неподтверждённой до кросс-конфигурационной проверки #164. Сейчас #164
заблокирована отсутствием второй независимой выгрузки, а #165 не реализуется до
подтверждения #164 и отдельного доказательства человекочитаемых имён.
