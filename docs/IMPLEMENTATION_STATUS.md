...
По [карточке roadmap](https://github.com/MRDK80/v8unpack-agent/issues/157)
отмечены выполненными 49 из 50 пунктов. Открытый пункт — #210, финальная
интеграционная проверка документации и закрытие roadmap; до завершения этой
проверки эпик остаётся в работе.
