...
Результат на конфигурации УТ 10.3 (2231 директория форм):
...
Для изменений, влияющих на классификацию форм или метрики покрытия,
дополнительно прогоняется верификация на production-выгрузке:
