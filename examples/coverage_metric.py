...
# Форма Catalog/Банки/ФормаЭлементаУправляемая — 19 элементов:
...
def demo_old_vs_new() -> None:
    ...
    print("=== Старая метрика vs новая (форма Банки, 19 элементов) ===")
...
def demo_json_report() -> None:
    ...
    output = {
        ...
        "note": (
            "3 поля из DATA_ELEMENT_TYPES без data_path — платформенные реквизиты "
            "(Код, Наименование, Родитель). Будут разрешены в issue #88."
        ),
    }
